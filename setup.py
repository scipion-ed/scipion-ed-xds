...
setup(
    ...
    description='Workflow plugin for Electron Diffraction image processing with XDS',  # Required
    ...
    url='https://github.com/scipion-ed/scipion-ed-xds',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/scipion-ed/scipion-ed-xds/issues',
        'Source': 'https://github.com/scipion-ed/scipion-ed-xds/',
    },
)
