...
def readInputImages(inputImages):
    ...
    parameters = {}
    parameters['NameTemplate'] = f"{firstimage.getDirName()}/0????.img"
...
def writeTemplate(inputImages, outputpath=None, **kwargs):
    ...
    template = (f"""! XDS.INP file for Rotation Electron Diffraction generated by `scipion-ed-xds`
    ...
    with open("XDS.INP", "w") as text_file:
        print(f"{template}", file=text_file)
